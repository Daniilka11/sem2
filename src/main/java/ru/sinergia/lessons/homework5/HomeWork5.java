package ru.sinergia.lessons.homework5;
...
public class HomeWork5 {
    ...
    */
    ...
    public static class Person {
        ...
        protected Person(String name, int health, int protection){
            this.name = name;
            this.health = health;
        ...
        public String announce(){
            return String.format("Person %s имеет характеристики: %s здоровья и %s защиты", name, health, protection);
        }
        ...
        public void takeDamage(Integer damage) throws PersonDead {
            ...
            if (health < 0) {
                health = 0;
                throw new PersonDead("убили парня");
            }
        }
    ...
    public static class Mage extends Person{
        ...
        public void takeDamage(Integer damage) throws PersonDead {
            ...
            if (getHealth() < 0) {
                throw new PersonDead("убили мага");
            }
        }
