package ru.sinergia.lessons.homework3;
...
public class  HomeWork3 {
    ...
    public static void raiseException(Integer exceptionId) throws Exception { // Подсказка: throws Exception в итоге надо поменять на перечисление имен исключений
        switch (exceptionId){
            case 1:
                throw new SocketException("число равно 1");
            case 2:
                throw new ClassNotFoundException("число равно 2");
            case 3:
                throw new AccessDeniedException("число равно 3");
            case 4:
                throw new ExportException("число равно 4");
