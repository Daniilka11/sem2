package ru.sinergia.lessons.homework2;
...
import static ru.sinergia.lessons.homework2.HomeWork2.LoginValidationException.isLoginValid;
import static ru.sinergia.lessons.homework2.HomeWork2.LoginValidationException.validateLogin;
...
public class HomeWork2 {
    ...
    public static class LoginValidationException extends Exception {
        ...
        public static void validateLogin(String login) throws LoginValidationException {
            String exp = "((?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=._).{0,20})";
//              if (login.matches(exp)){
...
//              }
            ...
            for (char character : chars) {
                ...
                if (Character.toString(character).equals("_")){
                    ul =false;
                }
            }
