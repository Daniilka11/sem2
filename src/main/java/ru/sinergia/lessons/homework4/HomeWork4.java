package ru.sinergia.lessons.homework4;
...
public class HomeWork4 {
    ...
    public static HashMap<String, Integer> magSort(HashMap<String, Integer> shopCart) {
        ...
        for(String name : shopCart.keySet()) {
            if (shopCart.get(name) <= 300){
                //записываем новый элемент весом меньше или равным 300
                res.put(name, shopCart.get(name));
            }
        }
        return res;
    }
